...
document.getElementById('map-group').insertBefore(document.getElementById('states'), document.getElementById('campus-line0'));
    ...
    svg.append("image")
        ...
        .attr('href','assets/youth/campus1.svg')
        .attr('x',width/8)
        .attr('y',height/8-20)
    ...
    svg.append("image")
        ...
        .attr('class',"campus-image")
        .attr('href','assets/youth/campus4.svg')
        .attr('x',width*0.63)
        .attr('y',-10)
    ...
    svg.append("image")
        ...
        .attr('class',"campus-image")
        .attr('href','assets/youth/campus2.svg')
        .attr('x',width*0.6)
        .attr('y',height*0.65)
    ...
    svg.append("image")
        ...
        .attr('class',"campus-image")
        .attr('href','assets/youth/campus3.svg')
        .attr('x',0)
        .attr('y',height*0.4)
    ...
    var data_logo = svg.append("image")
        .attr('id',"data-logo")
        .attr('href','assets/youth/vdo-logo.svg')
